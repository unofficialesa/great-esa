...
OneClick <- function(Mod){
  
  potato <- Mod

for (i in 1:resol){
  G0V_Up[i] <-( (Distribution(i,486.34,44.052))*potato)
}
i <- 0

for (i in 1:resol){
  G0V_Down[i] <- ((Distribution(i,604.93, 16.459))* potato)
}
i <- 0

for (i in 1:resol){
  G2V_Up[i] <- ((Distribution(i,499.65, 50.844)) * potato)
}
i <- 0

for (i in 1:resol){
  G2V_Down[i] <-    ((Distribution(i,629.87, 15.591)) * potato)
}
i <- 0

for (i in 1:resol){
  K0V_Up[i] <-       ((Distribution(i,547.25, 75.127)) * potato)
}
i <- 0

for (i in 1:resol){
  K0V_Down[i] <-   (((Distribution(i,423.177, 11.825)) + (Distribution(i,710.85, 8.3424))) * potato)
}
i <- 0

for (i in 1:resol){
  M0V_Up[i] <-    ((Distribution(i,749.09, 178.10)) * potato)
}
i <- 0
...
Rated_G0V_Up_X <- (Rate)*(Integral_G0V_Up_X)
Rated_G0V_Up_Y <- (Rate)*(Integral_G0V_Up_Y)
Rated_G0V_Up_Z <- (Rate)*(Integral_G0V_Up_Z)
Rated_G0V_Down_X <- (Rate)*(Integral_G0V_Down_X)
Rated_G0V_Down_Y <- (Rate)*(Integral_G0V_Down_Y)
Rated_G0V_Down_Z <- (Rate)*(Integral_G0V_Down_Z)
Rated_G2V_Up_X <- (Rate)*(Integral_G2V_Up_X)
Rated_G2V_Up_Y <- (Rate)*(Integral_G2V_Up_Y)
Rated_G2V_Up_Z <- (Rate)*(Integral_G2V_Up_Z)
Rated_G2V_Down_X <- (Rate)*(Integral_G2V_Down_X)
Rated_G2V_Down_Y <- (Rate)*(Integral_G2V_Down_Y)
Rated_G2V_Down_Z <- (Rate)*(Integral_G2V_Down_Z)
Rated_K0V_Up_X <- (Rate)*(Integral_K0V_Up_X)
Rated_K0V_Up_Y <- (Rate)*(Integral_K0V_Up_Y)
Rated_K0V_Up_Z <- (Rate)*(Integral_K0V_Up_Z)
Rated_K0V_Down_X <- (Rate)*(Integral_K0V_Down_X)
Rated_K0V_Down_Y <- (Rate)*(Integral_K0V_Down_Y)
Rated_K0V_Down_Z <- (Rate)*(Integral_K0V_Down_Z)
Rated_M0V_Up_X <- (Rate)*(Integral_M0V_Up_X)
Rated_M0V_Up_Y <- (Rate)*(Integral_M0V_Up_Y)
Rated_M0V_Up_Z <- (Rate)*(Integral_M0V_Up_Z)
...
for(i in 1:resol){
  ...
  Integral_Energy <- ((Integral_Energy) + (Energy[i]))  
...
Luminunce <- (myTemparature^4)*((5.670400)*(10^(-8)))




#G0V_Up 151.3 116.2 86.4
# G0V_Down 95.7 88.9 112.4
# G2V_Up 147.8 111.7 92.1
# G2V_Down 113.0 106.4 112.5
# K0V_Up 136.1 104.6 102.4
# K0V_Down 149.1 126.6 61.6
# M0V_Up 150.5 120.1 110.0
